#!/bin/bash
#SBATCH --job-name=rca_trf_c5_382062
...
OUTPUT_DIR=/scratch/yuvraj17/adaptive_tracing_scratch/adaptive_tracer/logs/root_cause_transformer_multitask_cats5_382062_hdbscan
...
echo "Mode         : Root Cause Eval | Transformer | Multitask | cats5"
