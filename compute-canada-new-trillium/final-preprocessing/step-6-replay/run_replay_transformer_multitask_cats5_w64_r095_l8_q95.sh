#!/bin/bash
#SBATCH --job-name=atr_trf_c5_w64r095l8q95
...
OUTPUT_DIR=/scratch/yuvraj17/adaptive_tracing_scratch/adaptive_tracer/logs/adaptive_trace_replay_transformer_multitask_cats5_382062_w64_r095_l8_q95
...
echo "Mode         : Adaptive Replay | Transformer | cats5 | w64 r0.95 l8 | q=0.95"
